  ...
  const columns = [
    {
      ...
      dataIndex: "sku",
      sorter: true,
      sortOrder: columnSortOrder(sorter, "sku"),
      width: 140,
    },
    {
      title: "Tên",
      dataIndex: "name",
      sorter: true,
      sortOrder: columnSortOrder(sorter, "name"),
    },
    { title: "Nhóm", dataIndex: "categoryName", width: 140 },
    {
      ...
      dataIndex: "unit",
      width: 90,
      render: (u) => UNIT_LABEL[u] || u,
    },
    {
      title: "Giá bán",
      dataIndex: "price",
      sorter: true,
      sortOrder: columnSortOrder(sorter, "price"),
      width: 120,
      align: "right",
      ...
      <FitTable
        ...
        emptyState={
          <EmptyState
            title={
              keyword
                ? `Không tìm thấy sản phẩm khớp "${keyword}"`
            ...
            action={
              keyword
                ...
                : {
                    label: "Thêm sản phẩm",
                    onClick: openCreate,
                    permission: P.MASTER_PRODUCT_MANAGE,
                  }
            }
            secondary={
              keyword
      ...
      >
        <Form form={form} layout="vertical">
          ...
          <Space style={{ display: "flex" }} align="start" wrap>
            ...
            <Form.Item name="volume" label="Thể tích (m3)">
              <InputNumber min={0} style={{ width: 120 }} />
            </Form.Item>
          </Space>
          <Form.Item
